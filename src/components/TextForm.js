...
export default function Tex(props) {
  ...
  return (
    <>
      <div className={`mx-5`}>
        <div>
          {/* <marquee behavior="alternate" direction="right"> */}
            <h1 className={`my-4 shadow-sm p-3 bg-${props.mode === 'light'  ? 'light':'dark'} text-${props.mode === 'light'? 'dark':'light'} rounded `}>{props.heading}</h1>
          {/* </marquee> */}
          <div className="mb-3">
            <textarea
              className={`form-control bg-${props.mode === 'light'? 'light':'dark'} text-${props.mode === 'light'? 'dark':'light'} rounded`}
          ...
          <div className="w-100 d-flex justify-content-around flax-wrap">
            <button
              className={`btn btn-${props.mode === 'light'? 'secondary':'dark'} w-25 mx-1 fs-5 fw-bold`}
      ...
      <div className={`my-1 mx-5 bg-${props.mode === 'light'? 'light':'dark'} text-${props.mode === 'light'? 'dark':'light'}`}>
        <h1 className={`shadow-sm p-3 mt-5 bg-${props.mode === 'light'? 'light':'dark'} rounded text-${props.mode === 'light'? 'dark':'light'}`}>
          Your Text Summary
        </h1>
        <ul className="mx-5">
          <li>
        ...
        <h1 className={`shadow-sm p-3 mb-5rounded bg-${props.mode === 'light'? 'light':'dark'} text-${props.mode === 'light'? 'dark':'light'}`}>Preview</h1>
        <p className="fs-6 bg-${props.mode === 'light'? 'light':'dark'} text-${props.mode === 'light'? 'dark':'light'} mx-5">{text}</p>
      </div>
    </>
  );
}
